                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            ...
                            <a href="/kandidat/create" class="btn btn-warning">Tambah Kandidat</a>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="example3" class="display" style="min-width: 845px">
                                    ...
                                    <tbody>
                                        @foreach ($kandidats as $get)
                                            <tr>
                                                <td>{{ $loop->iteration }}</td>
                                                <td>{{ $get->nama_kandidat }}</td>
                                                <td>{{ $get->calon_kandidat }}</td>
                                                {{-- <td>{{ $get->foto_kandidat }}</td> --}}

                                                <td>
                                                    <img src="{{ asset('pendaftar') }}/{{ $get->foto_kandidat }}"
                                                        width="50" alt="">
                                                </td>
