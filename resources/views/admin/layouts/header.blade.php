        ...
        <div class="dlabnav-scroll">
            <ul class="metismenu" id="menu">
                ...
                @if (Auth::user()->role !== 'siswa')
                    <li class="">
                        <a class=" ai-icon" href="/kelas" aria-expanded="false">
                ...
                @endif
                <li class="">
                    <a class=" ai-icon" href="/suara" aria-expanded="false">
                        <i class="fa-solid fa-gear fw-bold"></i>
                        <span class="nav-text">Suara</span>
                    </a>
                </li>
                <li><a class=" ai-icon" href="/logout" aria-expanded="false">
                        <i class="fa-solid fa-gear fw-bold"></i>
                        <span class="nav-text">Logout</span>
                    </a>
                </li>
                {{-- <li><a class=" ai-icon" href="/voters" aria-expanded="false">
                        <i class="fa-solid fa-gear fw-bold"></i>
                        <span class="nav-text">Voters</span>
                    </a>
                </li>
                <li><a class=" ai-icon" href="/vote" aria-expanded="false">
                        <i class="fa-solid fa-gear fw-bold"></i>
